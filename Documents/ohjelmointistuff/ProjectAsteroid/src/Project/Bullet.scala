...
class PlayerBullet(x0:Double, y0:Double) extends Bullet(new Image("file:Images/blast_1.png", 50, 25, true, false)) {  // blast_1.png:n alkuperäinen koko on 20 x 10 pikseliä
